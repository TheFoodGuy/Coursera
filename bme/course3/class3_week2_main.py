...
def localAlignmentTest(str1='MEANLY', str2='PENALTY'): 
    localAlignment(str1, str2)

def globalAlignmentTest(str1='PLEASANTLY', str2='MEANLY'): 
    a,b = globalAlignment(str1, str2)
...
def main(): 
    ...
    #     if sys.argv[1] != '1':
    #         globalAlignmentTest(firstseq, secondseq)
    #     else: 
    #         globalAlignmentTest('MEANLY','PENALTY')
        # localAlignmentTest(firstseq, secondseq)
        ...
        # for ki, vi in PAM250.items():
        #     for kj, vj in vi.items():
        #         if ki == kj:
        #             PAM250[ki][kj] = 1
        #         else:
        #             PAM250[ki][kj] = 1
        # print(editDistance(firstseq, secondseq))

        overlapAlignment(firstseq, secondseq)
